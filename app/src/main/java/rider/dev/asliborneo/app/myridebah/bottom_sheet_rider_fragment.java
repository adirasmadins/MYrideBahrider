...
public class bottom_sheet_rider_fragment extends BottomSheetDialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v=inflater.inflate(R.layout.activity_bottom_sheet_rider,container,false);
        location = (TextView) v.findViewById(R.id.txtLocation);
        destination = (TextView) v.findViewById(R.id.txtDestination);
        distance=(TextView) v.findViewById(R.id.txtTotal);
    ...
    private void getPrice(String mlocation, String mdestination) {
        ...
        Call<Directions> call=service.getPath("driving","less_driving",mlocation,mdestination,"AIzaSyBcbLAMZ8lY23ch55Oq5xuGbe58w7SRKn8");
            ...
            public void onResponse(Call<Directions> call, Response<Directions> response) {
                if (response.body() != null) {
                    if (response.body().routes.size() > 0)    {
                                ...
                                String final_calculate = String.format("%s + %s = RM%.2f", distance_text, time_text, Commons.getPrice(distance_value, time_value));
