...
import rider.dev.asliborneo.app.myridebah.Helper.GoogleMapAnimationHelper;
import rider.dev.asliborneo.app.myridebah.Helper.GoogleMapHelper;
import rider.dev.asliborneo.app.myridebah.Helper.TestValues;

/**
 * Launcher activity with Google Map fragment
 */

public class MapActivity extends FragmentActivity implements GoogleMap.OnMapLoadedCallback,
...
//                BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_AZURE)));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.string.action_marker:
                mMarker.setVisible(!mMarker.isVisible());
                return true;

            case R.string.action_buildings:
                mMap.setBuildingsEnabled(!mMap.isBuildingsEnabled());
                return true;

            case R.string.action_animation:
            ...
            case R.string.action_perspective:
